...
# Attack sysex byte (0-127) -> normalized slider (0-1)
# PCHIP fit from measured Juno-106 slider positions.
# Attack has a strongly nonlinear curve (steep at low bytes).
# Decay and Release are close enough to linear to use byte/127.
ATTACK_SYSEX_LUT = [
    0.0000, 0.0593, 0.1190, 0.1790, 0.2158, 0.2390, 0.2504, 0.2582,
    0.2660, 0.2755, 0.2855, 0.2953, 0.3043, 0.3120, 0.3182, 0.3234,
    0.3283, 0.3333, 0.3390, 0.3459, 0.3536, 0.3616, 0.3693, 0.3760,
    0.3820, 0.3878, 0.3935, 0.3989, 0.4042, 0.4094, 0.4145, 0.4194,
    0.4242, 0.4289, 0.4335, 0.4381, 0.4425, 0.4469, 0.4513, 0.4556,
    0.4599, 0.4642, 0.4684, 0.4727, 0.4770, 0.4813, 0.4855, 0.4898,
    0.4939, 0.4981, 0.5022, 0.5062, 0.5101, 0.5140, 0.5178, 0.5215,
    0.5251, 0.5286, 0.5320, 0.5352, 0.5380, 0.5408, 0.5436, 0.5466,
    0.5500, 0.5535, 0.5570, 0.5607, 0.5646, 0.5691, 0.5742, 0.5801,
    0.5870, 0.5986, 0.6166, 0.6376, 0.6586, 0.6765, 0.6880, 0.6947,
    0.7004, 0.7052, 0.7092, 0.7128, 0.7160, 0.7188, 0.7211, 0.7231,
    0.7250, 0.7268, 0.7288, 0.7312, 0.7340, 0.7372, 0.7408, 0.7445,
    0.7486, 0.7529, 0.7574, 0.7622, 0.7673, 0.7727, 0.7782, 0.7841,
    0.7902, 0.7966, 0.8032, 0.8100, 0.8172, 0.8246, 0.8322, 0.8401,
    0.8482, 0.8566, 0.8652, 0.8741, 0.8833, 0.8926, 0.9023, 0.9121,
    0.9223, 0.9326, 0.9433, 0.9541, 0.9652, 0.9766, 0.9882, 1.0000,
]
...
def read_pat_patches(path):
    ...
    for line in lines:
        ...
        # Attack (byte 11) uses nonlinear sysex→slider LUT
        n[11] = ATTACK_SYSEX_LUT[b[11]]
