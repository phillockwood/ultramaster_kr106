...
if(t==='btnled')return{x,y,w:17,h:28};return{x,y,w:0,h:0}}
...
const baseY=y+trackY+1, pointY=y+trackY+1;
...
function drawPresetDisplay(){ctx.fillStyle='#000';ctx.fillRect(790,86,128,14);ctx.save();ctx.beginPath();ctx.rect(790,86,128,14);ctx.clip();ctx.fillStyle='#0dc000';ctx.font="11px 'Segment14', monospace";ctx.fillText(synth.ready?synth.getPresetName(currentPreset):'Loading...',793,97);ctx.restore()}
